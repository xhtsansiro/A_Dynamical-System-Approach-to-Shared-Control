#ifndef KUKA_LWR_FIX_POINT_H
#define KUKA_LWR_FIX_POINT_H
...
class Fix_point_action : public ros_controller_interface::Ros_ee_j, public ac::Base_action {

public:


    Fix_point_action(ros::NodeHandle& nh);
