#ifndef KUKA_LWR_POS_RESTART_H
#define KUKA_LWR_POS_RESTART_H
...
class Pos_restart_action : public ros_controller_interface::Ros_ee_j, public ac::Base_action {

public:


    Pos_restart_action(ros::NodeHandle& nh);
