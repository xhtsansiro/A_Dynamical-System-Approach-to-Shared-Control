...
int main(int argc, char** argv)
{
    ...
    client_console.AddConsoleCommand("Guidance");
    client_console.AddConsoleCommand("Restart");
    client_console.AddConsoleCommand("LfD"); 
    client_console.AddConsoleCommand("Fix_point");
    client_console.AddConsoleCommand("Compare");
